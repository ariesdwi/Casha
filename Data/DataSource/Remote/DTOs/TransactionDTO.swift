...
//         case updatedAt = "updated_at"
    ...
    public func toDomain() -> TransactionCasha {
        TransactionCasha(
            ...
            isConfirm: true,
            createdAt: ISO8601DateFormatter().date(from: datetime) ?? Date(),   // Or parse if provided
            updatedAt: ISO8601DateFormatter().date(from: datetime) ?? Date()    // Or parse if provided
        )
    }
}
